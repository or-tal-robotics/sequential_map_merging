...
stat_path_de =  packadge_path + '/statistics/csv/MonteCarloStatistics_de_map3v3.csv'
stat_path_pf =  packadge_path + '/statistics/csv/MonteCarloStatistics_pf_map3v3.csv'
